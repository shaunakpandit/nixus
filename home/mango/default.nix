  ...
  wayland.windowManager.mango = {
    ...
    settings = {
      bind = [
        ...
        "SUPER,n,toggle_named_scratchpad,none,notes-scratch,ghostty --title=notes-scratch -e sh -lc 'tmux new-session -A -s notes -c \"$HOME/notes\" nvim'"
      ...
      windowrule = [
        ...
        "monitor:eDP-1,title:newsboat-2,isfloating:1,tags:2,offsetx:-95,offsety:90,width:813,height:966"
        "monitor:eDP-1,title:btop-2,isfloating:1,tags:2,offsetx:90,offsety:-80,width:980,height:568"
        "monitor:eDP-1,title:cava-2,isfloating:1,tags:2,offsetx:85,offsety:80,width:692,height:273"
    ...
    autostart_sh = ''
        waybar &
        swaybg \
          -o eDP-1 -i "$HOME/dev/nixus/walls/shiri.jpeg" -m fill \
